//
//  CKSegmentControlComponent.swift
//  CraftKitExample
//
...
struct CKSegmentControlComponent: View {
...
struct CKSegmentControlComponent_Previews: PreviewProvider {
    static var previews: some View {
        CKSegmentControlComponent()
    }
}
