...
public extension API {
  class CancelCoachRequestMutation: GraphQLMutation {
    public static let operationName: String = "CancelCoachRequest"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation CancelCoachRequest($coachshipId: ObjectID!) { cancelCoachRequest(coachshipId: $coachshipId) { __typename ...CoachshipFields } }"#,
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("cancelCoachRequest", CancelCoachRequest.self, arguments: ["coachshipId": .variable("coachshipId")]),
      ] }

      public var cancelCoachRequest: CancelCoachRequest { __data["cancelCoachRequest"] }

      /// CancelCoachRequest
      ///
      /// Parent Type: `Coachship`
      public struct CancelCoachRequest: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
