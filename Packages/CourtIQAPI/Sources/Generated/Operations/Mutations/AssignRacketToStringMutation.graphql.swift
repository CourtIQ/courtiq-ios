...
public extension API {
  class AssignRacketToStringMutation: GraphQLMutation {
    public static let operationName: String = "AssignRacketToString"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation AssignRacketToString($racketId: ObjectID!, $stringId: ObjectID!) { assignRacketToString(racketId: $racketId, stringId: $stringId) { __typename ...TennisStringFields } }"#,
        fragments: [TennisStringFields.self]
      ))

    public var racketId: ObjectID
    public var stringId: ObjectID
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("assignRacketToString", AssignRacketToString.self, arguments: [
          "racketId": .variable("racketId"),
          "stringId": .variable("stringId")
        ]),
      ] }

      public var assignRacketToString: AssignRacketToString { __data["assignRacketToString"] }

      /// AssignRacketToString
      ///
      /// Parent Type: `TennisString`
      public struct AssignRacketToString: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
