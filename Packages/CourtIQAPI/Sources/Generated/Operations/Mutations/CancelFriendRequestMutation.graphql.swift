...
public extension API {
  class CancelFriendRequestMutation: GraphQLMutation {
    public static let operationName: String = "CancelFriendRequest"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation CancelFriendRequest($friendshipId: ObjectID!) { cancelFriendRequest(friendshipId: $friendshipId) { __typename ...FriendshipFields } }"#,
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("cancelFriendRequest", CancelFriendRequest.self, arguments: ["friendshipId": .variable("friendshipId")]),
      ] }

      public var cancelFriendRequest: CancelFriendRequest { __data["cancelFriendRequest"] }

      /// CancelFriendRequest
      ///
      /// Parent Type: `Friendship`
      public struct CancelFriendRequest: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
