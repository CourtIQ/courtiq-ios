...
public extension API {
  class AcceptStudentRequestMutation: GraphQLMutation {
    public static let operationName: String = "AcceptStudentRequest"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation AcceptStudentRequest($coachshipId: ObjectID!) { acceptStudentRequest(coachshipId: $coachshipId) { __typename ...CoachshipFields } }"#,
    ...
    public struct Data: API.SelectionSet {
      ...
      public struct AcceptStudentRequest: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
