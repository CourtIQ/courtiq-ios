...
public extension API {
  class RemoveStudentMutation: GraphQLMutation {
    public static let operationName: String = "RemoveStudent"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation RemoveStudent($coachshipId: ObjectID!) { removeStudent(coachshipId: $coachshipId) { __typename ...CoachshipFields } }"#,
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("removeStudent", RemoveStudent?.self, arguments: ["coachshipId": .variable("coachshipId")]),
      ] }

      public var removeStudent: RemoveStudent? { __data["removeStudent"] }

      /// RemoveStudent
      ///
      /// Parent Type: `Coachship`
      public struct RemoveStudent: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
