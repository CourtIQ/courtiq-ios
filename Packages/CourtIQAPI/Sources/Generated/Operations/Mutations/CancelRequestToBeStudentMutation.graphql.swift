...
public extension API {
  class CancelRequestToBeStudentMutation: GraphQLMutation {
    public static let operationName: String = "CancelRequestToBeStudent"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation CancelRequestToBeStudent($coachshipId: ObjectID!) { cancelRequestToBeStudent(coachshipId: $coachshipId) { __typename ...CoachshipFields } }"#,
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("cancelRequestToBeStudent", CancelRequestToBeStudent.self, arguments: ["coachshipId": .variable("coachshipId")]),
      ] }

      public var cancelRequestToBeStudent: CancelRequestToBeStudent { __data["cancelRequestToBeStudent"] }

      /// CancelRequestToBeStudent
      ///
      /// Parent Type: `Coachship`
      public struct CancelRequestToBeStudent: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
