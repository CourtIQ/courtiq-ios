...
public extension API {
  class AcceptFriendRequestMutation: GraphQLMutation {
    public static let operationName: String = "AcceptFriendRequest"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation AcceptFriendRequest($friendshipId: ObjectID!) { acceptFriendRequest(friendshipId: $friendshipId) { __typename ...FriendshipFields } }"#,
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("acceptFriendRequest", AcceptFriendRequest.self, arguments: ["friendshipId": .variable("friendshipId")]),
      ] }

      public var acceptFriendRequest: AcceptFriendRequest { __data["acceptFriendRequest"] }

      /// AcceptFriendRequest
      ///
      /// Parent Type: `Friendship`
      public struct AcceptFriendRequest: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
