...
public extension API {
  class GetFriendshipQuery: GraphQLQuery {
    public static let operationName: String = "GetFriendship"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query GetFriendship($id: ObjectID!) { friendship(id: $id) { __typename ...FriendshipFields } }"#,
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("friendship", Friendship?.self, arguments: ["id": .variable("id")]),
      ] }
