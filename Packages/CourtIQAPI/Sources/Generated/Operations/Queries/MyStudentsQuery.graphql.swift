...
public extension API {
  class MyStudentsQuery: GraphQLQuery {
    public static let operationName: String = "MyStudents"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query MyStudents($limit: Int = 10, $offset: Int = 0) { myStudents(limit: $limit, offset: $offset) { __typename ...CoachshipFields } }"#,
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("myStudents", [MyStudent].self, arguments: [
          "limit": .variable("limit"),
          "offset": .variable("offset")
        ]),
      ] }

      public var myStudents: [MyStudent] { __data["myStudents"] }

      /// MyStudent
      ///
      /// Parent Type: `Coachship`
      public struct MyStudent: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
