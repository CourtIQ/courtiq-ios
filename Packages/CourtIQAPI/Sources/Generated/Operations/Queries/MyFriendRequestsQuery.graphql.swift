...
public extension API {
  class MyFriendRequestsQuery: GraphQLQuery {
    public static let operationName: String = "MyFriendRequests"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query MyFriendRequests { myFriendRequests { __typename ...FriendshipFields } }"#,
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("myFriendRequests", [MyFriendRequest].self),
      ] }

      public var myFriendRequests: [MyFriendRequest] { __data["myFriendRequests"] }

      /// MyFriendRequest
      ///
      /// Parent Type: `Friendship`
      public struct MyFriendRequest: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
