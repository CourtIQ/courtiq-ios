...
public extension API {
  class MyStringHistoryQuery: GraphQLQuery {
    public static let operationName: String = "MyStringHistory"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query MyStringHistory($racket: ObjectID!) { myStringHistory(racket: $racket) { __typename ...TennisStringFields } }"#,
        fragments: [TennisStringFields.self]
      ))

    public var racket: ObjectID

    public init(racket: ObjectID) {
      self.racket = racket
    }

    public var __variables: Variables? { ["racket": racket] }
    ...
    public struct Data: API.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("myStringHistory", [MyStringHistory].self, arguments: ["racket": .variable("racket")]),
      ] }

      public var myStringHistory: [MyStringHistory] { __data["myStringHistory"] }

      /// MyStringHistory
      ///
      /// Parent Type: `TennisString`
      public struct MyStringHistory: API.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
